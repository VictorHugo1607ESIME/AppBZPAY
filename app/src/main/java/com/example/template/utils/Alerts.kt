...
class Alerts(private val context: Context) {
    ...
    fun alertValidateAction(confirmAction: Interfaces.ConfirmAction, message: String) {
        val inflater = LayoutInflater.from(context)
        val view: View = inflater.inflate(R.layout.custom_alert_validate_dialog, null)

        val noMaterialButton: MaterialButton = view.findViewById(R.id.btnNoAction)
        val yesMaterialButton: MaterialButton = view.findViewById(R.id.btnStartAction)
